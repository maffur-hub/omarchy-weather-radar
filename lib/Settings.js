...
function showLightning(settings) { return boolean(settings, "showLightning") }
function showRain(settings) { return read(settings, "showRain") !== false }
function showWind(settings) { return boolean(settings, "showWind") }
function showSynoptic(settings) { return boolean(settings, "showSynoptic") }
function showSatellite(settings) { return boolean(settings, "showSatellite") }
